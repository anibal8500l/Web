                ...
                <c:forEach var="court" items="${service.courts}">
                    <div class="4u 12u(medium)">
                        <section class="box feature">
                            ...
                            <div class="inner">
                                <header>
                                    <h2><c:out value="${service.getSportCenter(court.id).name}"/></h2>
                                </header>
                                <p><c:out value="${service.getSportCenter(court.id).phone}"/></p>
                                <p><c:out value="${service.getSportCenter(court.id).address}" /><br><br></p>
